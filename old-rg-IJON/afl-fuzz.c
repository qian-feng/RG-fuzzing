...
EXP_ST void setup_shm(void) {
  ...
  brc_shm_id = shmget(IPC_PRIVATE, sizeof(u8) * MAXMAP_SIZE, IPC_CREAT | IPC_EXCL | 0600);
  ...
  // map size of MAXMAP_SIZE, context sensitive branch id
  memset(brc_shm_bits, 0, MAXMAP_SIZE); 
